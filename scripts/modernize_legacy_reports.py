...
def beautify_legacy_html_content(raw_content: str, category: str, filename: str) -> str:
...
def beautify_legacy_report(file_path: Path, category: str) -> bool:
    ...
    modernized_html = beautify_legacy_html_content(raw_content, category, file_path.name)
    if modernized_html == raw_content:
        return False
...
def main():
    ...
    from scripts.sync_drive import build_reports_index, _atomic_write_if_changed
